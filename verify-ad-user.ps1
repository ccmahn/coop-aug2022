...
#>
   ...
   # PART 1 - Access the list of usernames from excel sheet
      ...
      #Open a given excel file (PATH CAN BE CHANGED OR ADD CONFIG FILE)
         ...
         $ExcelWorkBook = $ExcelObj.Workbooks.Open("C:\Users\ap721\Downloads\Field service users1.xlsx")
               ...
               for($i=2; $i -le $rowcount; $i++){
                     ...
                     # PART 3 - #Try to retrieve user. If a name does not exist in the specified group, store it in a text file called 'not-found.txt'     
                        ...
                        Try{
                              ...
                              #$ADUserInfo = Get-ADUser -filter "EmailAddress -eq '$($ADuseremail)'"
                              ...
                              #ensure user belongs to the specified AD group ("OneGIS Default" )

                              $group = "OneGIS Default"  
                              ...
                              #check if the $groupmembers list contains user $i, return yes or no
                                                ...
                                                If ($groupmembers -contains $ADUserInfo.Name ) {
                                                   ...
                                                   write-output "Group: GIS $group" "MemberOf: Yes `r" #`r`n formats the screen output spacing

                                                }

                                                Else {

                                                      write-output "GIS $group" "MemberOf: No `r"
